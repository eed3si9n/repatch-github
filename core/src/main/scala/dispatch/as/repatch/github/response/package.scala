...
package object response {
  ...
  val PackageVersions: Response => res.Paged[res.PackageVersion] =
    res.Paged.parseArray(res.PackageVersion.apply)

  val ReposSearch: Response => res.Paged[res.Repo] = res.Paged.parseSearchResult(res.Repo.apply)
  val CodeSearch: Response => res.Paged[res.BlobRef] =
    res.Paged.parseSearchResult(res.BlobRef.apply)
  ...
  val TextMatches: Response => res.Paged[res.TextMatches] =
    res.Paged.parseSearchResult(res.TextMatches.apply)
}
